...
#define nvme_show_verbose_result(msg, ...) nvme_show_verbose_message(true, msg, ##__VA_ARGS__)
#define nvme_show_verbose_info(msg, ...) nvme_show_verbose_message(false, msg, ##__VA_ARGS__)
