...
%extend libnvme_global_ctx {
	...
	void log_level(const char *level) {
		...
		else if (!strcmp(level, "notice")) log_level = LIBNVME_LOG_WARN;
		else if (!strcmp(level, "warning")) log_level = LIBNVME_LOG_WARN;
		else if (!strcmp(level, "err")) log_level = LIBNVME_LOG_ERR;
		else if (!strcmp(level, "crit")) log_level = LIBNVME_LOG_ERR;
		else if (!strcmp(level, "alert")) log_level = LIBNVME_LOG_ERR;
		else if (!strcmp(level, "emerg")) log_level = LIBNVME_LOG_ERR;
