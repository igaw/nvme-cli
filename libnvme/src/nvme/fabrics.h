 ...
 */
void nvmf_update_config(libnvme_ctrl_t c, const struct libnvme_fabrics_config *cfg);
 ...
 */
void nvmf_nbft_free(struct libnvme_global_ctx *ctx, struct nbft_file_entry *head);
