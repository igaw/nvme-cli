 ...
 */
int libnvme_gen_dhchap_key(struct nvme_global_ctx *ctx,
 ...
 */
int libnvme_lookup_keyring(struct nvme_global_ctx *ctx,
 ...
 */
char *libnvme_describe_key_serial(struct nvme_global_ctx *ctx,
		long key_id);
 ...
 * Return: 0 on success or negative error code otherwise
 */
int libnvme_lookup_key(struct nvme_global_ctx *ctx, const char *type,
 ...
 * Return: 0 on success or negative error code otherwise
 */
int libnvme_set_keyring(struct nvme_global_ctx *ctx, long keyring_id);
 ...
 * Return: 0 on success or negative error code otherwise
 */
int libnvme_read_key(struct nvme_global_ctx *ctx, long keyring_id,
 ...
 * Return: 0 on success or negative error code otherwise
 */
int libnvme_update_key(struct nvme_global_ctx *ctx, long keyring_id,
 ...
 */
int libnvme_scan_tls_keys(struct nvme_global_ctx *ctx, const char *keyring,
 ...
 * Return: 0 on success or negative error code otherwise
 */
int libnvme_insert_tls_key(struct nvme_global_ctx *ctx, const char *keyring,
 ...
 * Return: 0 on success or negative error code otherwise
 */
int libnvme_insert_tls_key_versioned(struct nvme_global_ctx *ctx,
 ...
 */
int libnvme_insert_tls_key_compat(struct nvme_global_ctx *ctx,
		const char *keyring, const char *key_type,
		const char *hostnqn, const char *subsysnqn,
		int version, int hmac,
		unsigned char *configured_key, int key_len,
 ...
 * Return: 0 on success or negative error code otherwise
 */
int libnvme_generate_tls_key_identity(struct nvme_global_ctx *ctx,
		const char *hostnqn, const char *subsysnqn,
		int version, int hmac,
		unsigned char *configured_key, int key_len,
		char **identity);
 ...
 * Return: 0 on success or negative error code otherwise
 */
int libnvme_generate_tls_key_identity_compat(struct nvme_global_ctx *ctx,
		const char *hostnqn, const char *subsysnqn,
 ...
 * Return: 0 on success or negative error code otherwise
 */
int libnvme_revoke_tls_key(struct nvme_global_ctx *ctx, const char *keyring,
		const char *key_type, const char *identity);
 ...
 * Return: 0 on success or negative error code otherwise
 */
int libnvme_export_tls_key(struct nvme_global_ctx *ctx,
 ...
 * Return: 0 on success or negative error code otherwise
 */
int libnvme_export_tls_key_versioned(struct nvme_global_ctx *ctx,
 ...
 * Return: 0 on success or negative error code otherwise
 */
int libnvme_import_tls_key(struct nvme_global_ctx *ctx, const char *encoded_key,
 ...
 * Return: 0 on success or negative error code otherwise
 */
int libnvme_import_tls_key_versioned(struct nvme_global_ctx *ctx,
