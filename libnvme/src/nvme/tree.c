...
static int nvme_subsystem_scan_namespace(struct libnvme_global_ctx *ctx,
					 struct libnvme_subsystem *s, char *name);
static int nvme_init_subsystem(libnvme_subsystem_t s, const char *name);
static int nvme_scan_subsystem(struct libnvme_global_ctx *ctx, const char *name);
static int nvme_ctrl_scan_namespace(struct libnvme_global_ctx *ctx, struct libnvme_ctrl *c,
				    char *name);
static int nvme_ctrl_scan_path(struct libnvme_global_ctx *ctx, struct libnvme_ctrl *c, char *name);
...
static void nvme_filter_subsystem(struct libnvme_global_ctx *ctx, libnvme_subsystem_t s,
...
static void nvme_filter_ns(struct libnvme_global_ctx *ctx, libnvme_ns_t n,
			   libnvme_scan_filter_t f, void *f_args)
{
...
static void nvme_filter_ctrl(struct libnvme_global_ctx *ctx, libnvme_ctrl_t c,
			     libnvme_scan_filter_t f, void *f_args)
{
...
static void nvme_filter_tree(struct libnvme_global_ctx *ctx, libnvme_scan_filter_t f, void *f_args)
{
	libnvme_host_t h, _h;
...
__public int libnvme_read_config(struct libnvme_global_ctx *ctx, const char *config_file)
{
	int err;
...
__public void libnvme_set_application(struct libnvme_global_ctx *ctx, const char *a)
{
...
__public struct libnvme_global_ctx *libnvme_host_get_global_ctx(libnvme_host_t h)
{
	return h->ctx;
}
...
static int nvme_subsystem_scan_namespaces(struct libnvme_global_ctx *ctx, libnvme_subsystem_t s)
{
...
static int nvme_ctrl_scan_paths(struct libnvme_global_ctx *ctx, struct libnvme_ctrl *c)
{
...
static int nvme_ctrl_scan_namespaces(struct libnvme_global_ctx *ctx, struct libnvme_ctrl *c)
{
	_cleanup_dirents_ struct dirents namespaces = {};
	int err, i;
...
static int nvme_ctrl_lookup_subsystem_name(struct libnvme_global_ctx *ctx,
...
static void nvme_read_sysfs_dhchap(struct libnvme_global_ctx *ctx, libnvme_ctrl_t c)
{
...
static void nvme_read_sysfs_tls(struct libnvme_global_ctx *ctx, libnvme_ctrl_t c)
{
	char *endptr;
	long key_id;
	char *key, *keyring;
...
static int nvme_reconfigure_ctrl(struct libnvme_global_ctx *ctx, libnvme_ctrl_t c, const char *path,
				 const char *name)
{
	DIR *d;
...
int nvme_ctrl_alloc(struct libnvme_global_ctx *ctx, libnvme_subsystem_t s,
...
static int nvme_ns_open(struct libnvme_global_ctx *ctx, const char *sys_path,
...
static int __nvme_scan_namespace(struct libnvme_global_ctx *ctx,
...
static int nvme_subsystem_scan_namespace(struct libnvme_global_ctx *ctx, libnvme_subsystem_t s,
		char *name)
{
	struct libnvme_ns *n, *_n, *__n;
	int ret;
