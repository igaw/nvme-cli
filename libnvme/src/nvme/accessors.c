...
__public void libnvme_ns_set_sysfs_dir(struct libnvme_ns *p, const char *sysfs_dir)
{
	free(p->sysfs_dir);
	p->sysfs_dir = sysfs_dir ? strdup(sysfs_dir) : NULL;
}
...
__public const char *libnvme_ctrl_get_dhchap_host_key(const struct libnvme_ctrl *p)
{
...
__public const char *libnvme_ctrl_get_dhchap_ctrl_key(const struct libnvme_ctrl *p)
{
	return p->dhchap_ctrl_key;
}

__public void libnvme_ctrl_set_keyring(struct libnvme_ctrl *p, const char *keyring)
{
	free(p->keyring);
...
__public const char *libnvme_ctrl_get_tls_key_identity(const struct libnvme_ctrl *p)
{
	return p->tls_key_identity;
}

__public void libnvme_ctrl_set_tls_key(struct libnvme_ctrl *p, const char *tls_key)
{
	free(p->tls_key);
...
__public bool libnvme_ctrl_get_unique_discovery_ctrl(const struct libnvme_ctrl *p)
{
	return p->unique_discovery_ctrl;
}

__public void libnvme_ctrl_set_discovered(struct libnvme_ctrl *p, bool discovered)
{
...
__public void libnvme_ctrl_set_persistent(struct libnvme_ctrl *p, bool persistent)
{
...
__public const char *libnvme_subsystem_get_name(const struct libnvme_subsystem *p)
{
	return p->name;
}
...
__public const char *libnvme_subsystem_get_model(const struct libnvme_subsystem *p)
{
	return p->model;
}

__public const char *libnvme_subsystem_get_serial(const struct libnvme_subsystem *p)
{
	return p->serial;
}

__public const char *libnvme_subsystem_get_firmware(const struct libnvme_subsystem *p)
{
	return p->firmware;
}
...
__public const char *libnvme_subsystem_get_iopolicy(const struct libnvme_subsystem *p)
{
	return p->iopolicy;
}
...
__public const char *libnvme_host_get_dhchap_host_key(const struct libnvme_host *p)
{
	return p->dhchap_host_key;
}
...
__public bool libnvme_fabric_options_get_nqn(const struct libnvme_fabric_options *p)
{
	return p->nqn;
}
...
__public bool libnvme_fabric_options_get_tls(const struct libnvme_fabric_options *p)
{
	return p->tls;
}
...
__public bool libnvme_fabric_options_get_tos(const struct libnvme_fabric_options *p)
{
	return p->tos;
}
