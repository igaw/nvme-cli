...
__public void libnvme_path_set_name(struct nvme_path *p, const char *name)
{
	free(p->name);
	p->name = name ? strdup(name) : NULL;
}

__public const char *libnvme_path_get_name(const struct nvme_path *p)
{
	return p->name;
}
...
__public const char *libnvme_path_get_sysfs_dir(const struct nvme_path *p)
{
	return p->sysfs_dir;
}
...
__public const char *libnvme_path_get_ana_state(const struct nvme_path *p)
{
	return p->ana_state;
}
...
__public const char *libnvme_path_get_numa_nodes(const struct nvme_path *p)
{
	return p->numa_nodes;
}

__public void libnvme_path_set_grpid(struct nvme_path *p, int grpid)
{
	p->grpid = grpid;
}

__public int libnvme_path_get_grpid(const struct nvme_path *p)
{
	return p->grpid;
}
...
__public void libnvme_ns_set_nsid(struct nvme_ns *p, __u32 nsid)
{
	p->nsid = nsid;
}

__public __u32 libnvme_ns_get_nsid(const struct nvme_ns *p)
{
	return p->nsid;
}

__public void libnvme_ns_set_name(struct nvme_ns *p, const char *name)
{
	free(p->name);
	p->name = name ? strdup(name) : NULL;
}

__public const char *libnvme_ns_get_name(const struct nvme_ns *p)
{
	return p->name;
}

__public void libnvme_ns_set_sysfs_dir(struct nvme_ns *p, const char *sysfs_dir)
{
	free(p->sysfs_dir);
	p->sysfs_dir = sysfs_dir ? strdup(sysfs_dir) : NULL;
}

__public const char *libnvme_ns_get_sysfs_dir(const struct nvme_ns *p)
{
	return p->sysfs_dir;
}

__public void libnvme_ns_set_lba_shift(struct nvme_ns *p, int lba_shift)
{
	p->lba_shift = lba_shift;
}

__public int libnvme_ns_get_lba_shift(const struct nvme_ns *p)
{
	return p->lba_shift;
}

__public void libnvme_ns_set_lba_size(struct nvme_ns *p, int lba_size)
{
	p->lba_size = lba_size;
}

__public int libnvme_ns_get_lba_size(const struct nvme_ns *p)
{
	return p->lba_size;
}

__public void libnvme_ns_set_meta_size(struct nvme_ns *p, int meta_size)
{
	p->meta_size = meta_size;
}

__public int libnvme_ns_get_meta_size(const struct nvme_ns *p)
{
	return p->meta_size;
}

__public void libnvme_ns_set_lba_count(struct nvme_ns *p, uint64_t lba_count)
{
	p->lba_count = lba_count;
}

__public uint64_t libnvme_ns_get_lba_count(const struct nvme_ns *p)
{
	return p->lba_count;
}

__public void libnvme_ns_set_lba_util(struct nvme_ns *p, uint64_t lba_util)
{
	p->lba_util = lba_util;
}

__public uint64_t libnvme_ns_get_lba_util(const struct nvme_ns *p)
{
	return p->lba_util;
}
...
__public const char *libnvme_ctrl_get_name(const struct nvme_ctrl *p)
{
	return p->name;
}

__public const char *libnvme_ctrl_get_sysfs_dir(const struct nvme_ctrl *p)
{
	return p->sysfs_dir;
}

__public const char *libnvme_ctrl_get_firmware(const struct nvme_ctrl *p)
{
	return p->firmware;
}

__public const char *libnvme_ctrl_get_model(const struct nvme_ctrl *p)
{
	return p->model;
}

__public const char *libnvme_ctrl_get_numa_node(const struct nvme_ctrl *p)
{
	return p->numa_node;
}

__public const char *libnvme_ctrl_get_queue_count(const struct nvme_ctrl *p)
{
	return p->queue_count;
}

__public const char *libnvme_ctrl_get_serial(const struct nvme_ctrl *p)
{
	return p->serial;
}

__public const char *libnvme_ctrl_get_sqsize(const struct nvme_ctrl *p)
{
	return p->sqsize;
}

__public const char *libnvme_ctrl_get_transport(const struct nvme_ctrl *p)
{
	return p->transport;
}

__public const char *libnvme_ctrl_get_subsysnqn(const struct nvme_ctrl *p)
{
	return p->subsysnqn;
}

__public const char *libnvme_ctrl_get_traddr(const struct nvme_ctrl *p)
{
	return p->traddr;
}

__public const char *libnvme_ctrl_get_trsvcid(const struct nvme_ctrl *p)
{
	return p->trsvcid;
}
...
__public const char *libnvme_ctrl_get_dhchap_host_key(const struct nvme_ctrl *p)
{
...
__public const char *libnvme_ctrl_get_dhchap_ctrl_key(const struct nvme_ctrl *p)
{
	return p->dhchap_ctrl_key;
}

__public void libnvme_ctrl_set_keyring(struct nvme_ctrl *p, const char *keyring)
{
	free(p->keyring);
	p->keyring = keyring ? strdup(keyring) : NULL;
}

__public const char *libnvme_ctrl_get_keyring(const struct nvme_ctrl *p)
{
	return p->keyring;
}
...
__public const char *libnvme_ctrl_get_tls_key_identity(const struct nvme_ctrl *p)
{
	return p->tls_key_identity;
}

__public void libnvme_ctrl_set_tls_key(struct nvme_ctrl *p, const char *tls_key)
{
	free(p->tls_key);
	p->tls_key = tls_key ? strdup(tls_key) : NULL;
}

__public const char *libnvme_ctrl_get_tls_key(const struct nvme_ctrl *p)
{
	return p->tls_key;
}

__public const char *libnvme_ctrl_get_cntrltype(const struct nvme_ctrl *p)
{
	return p->cntrltype;
}

__public const char *libnvme_ctrl_get_cntlid(const struct nvme_ctrl *p)
{
	return p->cntlid;
}

__public const char *libnvme_ctrl_get_dctype(const struct nvme_ctrl *p)
{
	return p->dctype;
}

__public const char *libnvme_ctrl_get_phy_slot(const struct nvme_ctrl *p)
{
	return p->phy_slot;
}

__public const char *libnvme_ctrl_get_host_traddr(const struct nvme_ctrl *p)
{
	return p->host_traddr;
}

__public const char *libnvme_ctrl_get_host_iface(const struct nvme_ctrl *p)
{
	return p->host_iface;
}
...
__public bool libnvme_ctrl_get_discovery_ctrl(const struct nvme_ctrl *p)
{
...
__public bool libnvme_ctrl_get_unique_discovery_ctrl(const struct nvme_ctrl *p)
{
	return p->unique_discovery_ctrl;
}

__public void libnvme_ctrl_set_discovered(struct nvme_ctrl *p, bool discovered)
{
	p->discovered = discovered;
}

__public bool libnvme_ctrl_get_discovered(const struct nvme_ctrl *p)
{
	return p->discovered;
}

__public void libnvme_ctrl_set_persistent(struct nvme_ctrl *p, bool persistent)
{
	p->persistent = persistent;
}

__public bool libnvme_ctrl_get_persistent(const struct nvme_ctrl *p)
{
	return p->persistent;
}
...
__public const char *libnvme_subsystem_get_name(const struct nvme_subsystem *p)
{
	return p->name;
}
...
__public const char *libnvme_subsystem_get_model(const struct nvme_subsystem *p)
{
	return p->model;
}

__public const char *libnvme_subsystem_get_serial(const struct nvme_subsystem *p)
{
	return p->serial;
}

__public const char *libnvme_subsystem_get_firmware(const struct nvme_subsystem *p)
{
	return p->firmware;
}
...
__public const char *libnvme_subsystem_get_iopolicy(const struct nvme_subsystem *p)
{
	return p->iopolicy;
}
...
__public const char *libnvme_host_get_hostnqn(const struct nvme_host *p)
{
	return p->hostnqn;
}

__public const char *libnvme_host_get_hostid(const struct nvme_host *p)
{
	return p->hostid;
}
...
__public const char *libnvme_host_get_dhchap_host_key(const struct nvme_host *p)
{
	return p->dhchap_host_key;
}
...
__public const char *libnvme_host_get_hostsymname(const struct nvme_host *p)
{
...
__public bool libnvme_host_get_pdc_enabled_valid(const struct nvme_host *p)
{
...
__public bool libnvme_fabric_options_get_nqn(const struct nvme_fabric_options *p)
{
	return p->nqn;
}
...
__public bool libnvme_fabric_options_get_tls(const struct nvme_fabric_options *p)
{
	return p->tls;
}
...
__public bool libnvme_fabric_options_get_tos(const struct nvme_fabric_options *p)
{
	return p->tos;
}
