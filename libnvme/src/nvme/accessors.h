 ...
 */
void libnvme_path_set_name(struct nvme_path *p, const char *name);
 ...
 */
const char *libnvme_path_get_name(const struct nvme_path *p);
 ...
 */
void libnvme_path_set_sysfs_dir(struct nvme_path *p, const char *sysfs_dir);
 ...
 */
const char *libnvme_path_get_sysfs_dir(const struct nvme_path *p);
 ...
 */
void libnvme_path_set_ana_state(struct nvme_path *p, const char *ana_state);
 ...
 */
const char *libnvme_path_get_ana_state(const struct nvme_path *p);
 ...
 */
void libnvme_path_set_numa_nodes(struct nvme_path *p, const char *numa_nodes);
 ...
 */
const char *libnvme_path_get_numa_nodes(const struct nvme_path *p);
 ...
 */
void libnvme_path_set_grpid(struct nvme_path *p, int grpid);
 ...
 */
int libnvme_path_get_grpid(const struct nvme_path *p);
 ...
 */
void libnvme_ns_set_nsid(struct nvme_ns *p, __u32 nsid);
 ...
 */
__u32 libnvme_ns_get_nsid(const struct nvme_ns *p);
 ...
 * @name: New string; a copy is stored. Pass NULL to clear.
 */
void libnvme_ns_set_name(struct nvme_ns *p, const char *name);
 ...
 * Return: The value of the name field, or NULL if not set.
 */
const char *libnvme_ns_get_name(const struct nvme_ns *p);
 ...
 * @sysfs_dir: New string; a copy is stored. Pass NULL to clear.
 */
void libnvme_ns_set_sysfs_dir(struct nvme_ns *p, const char *sysfs_dir);
 ...
 * Return: The value of the sysfs_dir field, or NULL if not set.
 */
const char *libnvme_ns_get_sysfs_dir(const struct nvme_ns *p);
 ...
 */
void libnvme_ns_set_lba_shift(struct nvme_ns *p, int lba_shift);
 ...
 */
int libnvme_ns_get_lba_shift(const struct nvme_ns *p);
 ...
 */
void libnvme_ns_set_lba_size(struct nvme_ns *p, int lba_size);
 ...
 */
int libnvme_ns_get_lba_size(const struct nvme_ns *p);
 ...
 */
void libnvme_ns_set_meta_size(struct nvme_ns *p, int meta_size);
 ...
 */
int libnvme_ns_get_meta_size(const struct nvme_ns *p);
 ...
 */
void libnvme_ns_set_lba_count(struct nvme_ns *p, uint64_t lba_count);
 ...
 */
uint64_t libnvme_ns_get_lba_count(const struct nvme_ns *p);
 ...
 */
void libnvme_ns_set_lba_util(struct nvme_ns *p, uint64_t lba_util);
 ...
 */
uint64_t libnvme_ns_get_lba_util(const struct nvme_ns *p);
 ...
 * Return: The value of the name field, or NULL if not set.
 */
const char *libnvme_ctrl_get_name(const struct nvme_ctrl *p);
 ...
 * Return: The value of the sysfs_dir field, or NULL if not set.
 */
const char *libnvme_ctrl_get_sysfs_dir(const struct nvme_ctrl *p);
 ...
 */
const char *libnvme_ctrl_get_firmware(const struct nvme_ctrl *p);
 ...
 */
const char *libnvme_ctrl_get_model(const struct nvme_ctrl *p);
 ...
 */
const char *libnvme_ctrl_get_numa_node(const struct nvme_ctrl *p);
 ...
 */
const char *libnvme_ctrl_get_queue_count(const struct nvme_ctrl *p);
 ...
 */
const char *libnvme_ctrl_get_serial(const struct nvme_ctrl *p);
 ...
 */
const char *libnvme_ctrl_get_sqsize(const struct nvme_ctrl *p);
 ...
 */
const char *libnvme_ctrl_get_transport(const struct nvme_ctrl *p);
 ...
 */
const char *libnvme_ctrl_get_subsysnqn(const struct nvme_ctrl *p);
 ...
 */
const char *libnvme_ctrl_get_traddr(const struct nvme_ctrl *p);
 ...
 */
const char *libnvme_ctrl_get_trsvcid(const struct nvme_ctrl *p);
 ...
 */
const char *libnvme_ctrl_get_dhchap_host_key(const struct nvme_ctrl *p);
 ...
 */
const char *libnvme_ctrl_get_dhchap_ctrl_key(const struct nvme_ctrl *p);
 ...
 */
void libnvme_ctrl_set_keyring(struct nvme_ctrl *p, const char *keyring);
 ...
 */
const char *libnvme_ctrl_get_keyring(const struct nvme_ctrl *p);
 ...
 */
const char *libnvme_ctrl_get_tls_key_identity(const struct nvme_ctrl *p);
 ...
 */
void libnvme_ctrl_set_tls_key(struct nvme_ctrl *p, const char *tls_key);
 ...
 */
const char *libnvme_ctrl_get_tls_key(const struct nvme_ctrl *p);
 ...
 */
const char *libnvme_ctrl_get_cntrltype(const struct nvme_ctrl *p);
 ...
 */
const char *libnvme_ctrl_get_cntlid(const struct nvme_ctrl *p);
 ...
 */
const char *libnvme_ctrl_get_dctype(const struct nvme_ctrl *p);
 ...
 */
const char *libnvme_ctrl_get_phy_slot(const struct nvme_ctrl *p);
 ...
 */
const char *libnvme_ctrl_get_host_traddr(const struct nvme_ctrl *p);
 ...
 */
const char *libnvme_ctrl_get_host_iface(const struct nvme_ctrl *p);
 ...
 */
void libnvme_ctrl_set_discovery_ctrl(struct nvme_ctrl *p, bool discovery_ctrl);
 ...
 */
bool libnvme_ctrl_get_discovery_ctrl(const struct nvme_ctrl *p);
 ...
 */
bool libnvme_ctrl_get_unique_discovery_ctrl(const struct nvme_ctrl *p);
 ...
 */
void libnvme_ctrl_set_discovered(struct nvme_ctrl *p, bool discovered);
 ...
 */
bool libnvme_ctrl_get_discovered(const struct nvme_ctrl *p);
 ...
 */
void libnvme_ctrl_set_persistent(struct nvme_ctrl *p, bool persistent);
 ...
 */
bool libnvme_ctrl_get_persistent(const struct nvme_ctrl *p);
 ...
 * Return: The value of the name field, or NULL if not set.
 */
const char *libnvme_subsystem_get_name(const struct nvme_subsystem *p);
 ...
 * Return: The value of the sysfs_dir field, or NULL if not set.
 */
const char *libnvme_subsystem_get_sysfs_dir(const struct nvme_subsystem *p);
 ...
 * Return: The value of the subsysnqn field, or NULL if not set.
 */
const char *libnvme_subsystem_get_subsysnqn(const struct nvme_subsystem *p);
 ...
 * Return: The value of the model field, or NULL if not set.
 */
const char *libnvme_subsystem_get_model(const struct nvme_subsystem *p);
 ...
 * Return: The value of the serial field, or NULL if not set.
 */
const char *libnvme_subsystem_get_serial(const struct nvme_subsystem *p);
 ...
 * Return: The value of the firmware field, or NULL if not set.
 */
const char *libnvme_subsystem_get_firmware(const struct nvme_subsystem *p);
 ...
 */
const char *libnvme_subsystem_get_subsystype(const struct nvme_subsystem *p);
 ...
 */
const char *libnvme_subsystem_get_application(const struct nvme_subsystem *p);
 ...
 */
const char *libnvme_subsystem_get_iopolicy(const struct nvme_subsystem *p);
 ...
 */
const char *libnvme_host_get_hostnqn(const struct nvme_host *p);
 ...
 */
const char *libnvme_host_get_hostid(const struct nvme_host *p);
 ...
 * Return: The value of the dhchap_host_key field, or NULL if not set.
 */
const char *libnvme_host_get_dhchap_host_key(const struct nvme_host *p);
 ...
 */
void libnvme_host_set_hostsymname(struct nvme_host *p, const char *hostsymname);
 ...
 */
const char *libnvme_host_get_hostsymname(const struct nvme_host *p);
 ...
 */
bool libnvme_host_get_pdc_enabled_valid(const struct nvme_host *p);
 ...
 */
void libnvme_fabric_options_set_cntlid(struct nvme_fabric_options *p, bool cntlid);
 ...
 */
bool libnvme_fabric_options_get_cntlid(const struct nvme_fabric_options *p);
 ...
 */
void libnvme_fabric_options_set_concat(struct nvme_fabric_options *p, bool concat);
 ...
 */
bool libnvme_fabric_options_get_concat(const struct nvme_fabric_options *p);
 ...
 */
bool libnvme_fabric_options_get_ctrl_loss_tmo(const struct nvme_fabric_options *p);
 ...
 */
bool libnvme_fabric_options_get_data_digest(const struct nvme_fabric_options *p);
 ...
 */
bool libnvme_fabric_options_get_dhchap_secret(const struct nvme_fabric_options *p);
 ...
 */
bool libnvme_fabric_options_get_discovery(const struct nvme_fabric_options *p);
 ...
 */
bool libnvme_fabric_options_get_hdr_digest(const struct nvme_fabric_options *p);
 ...
 */
bool libnvme_fabric_options_get_host_iface(const struct nvme_fabric_options *p);
 ...
 */
bool libnvme_fabric_options_get_host_traddr(const struct nvme_fabric_options *p);
 ...
 */
void libnvme_fabric_options_set_hostid(struct nvme_fabric_options *p, bool hostid);
 ...
 */
bool libnvme_fabric_options_get_hostid(const struct nvme_fabric_options *p);
 ...
 */
bool libnvme_fabric_options_get_hostnqn(const struct nvme_fabric_options *p);
 ...
 */
bool libnvme_fabric_options_get_instance(const struct nvme_fabric_options *p);
 ...
 */
bool libnvme_fabric_options_get_keyring(const struct nvme_fabric_options *p);
 ...
 */
void libnvme_fabric_options_set_nqn(struct nvme_fabric_options *p, bool nqn);
 ...
 */
bool libnvme_fabric_options_get_nqn(const struct nvme_fabric_options *p);
 ...
 */
bool libnvme_fabric_options_get_nr_io_queues(const struct nvme_fabric_options *p);
 ...
 */
bool libnvme_fabric_options_get_queue_size(const struct nvme_fabric_options *p);
 ...
 */
void libnvme_fabric_options_set_tls(struct nvme_fabric_options *p, bool tls);
 ...
 */
bool libnvme_fabric_options_get_tls(const struct nvme_fabric_options *p);
 ...
 */
bool libnvme_fabric_options_get_tls_key(const struct nvme_fabric_options *p);
 ...
 */
void libnvme_fabric_options_set_tos(struct nvme_fabric_options *p, bool tos);
 ...
 */
bool libnvme_fabric_options_get_tos(const struct nvme_fabric_options *p);
 ...
 */
void libnvme_fabric_options_set_traddr(struct nvme_fabric_options *p, bool traddr);
 ...
 */
bool libnvme_fabric_options_get_traddr(const struct nvme_fabric_options *p);
 ...
 */
bool libnvme_fabric_options_get_transport(const struct nvme_fabric_options *p);
 ...
 */
bool libnvme_fabric_options_get_trsvcid(const struct nvme_fabric_options *p);
