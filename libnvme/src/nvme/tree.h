 ...
 */
libnvme_host_t libnvme_first_host(struct nvme_global_ctx *ctx);
 ...
 */
libnvme_host_t libnvme_next_host(struct nvme_global_ctx *ctx, libnvme_host_t h);
 ...
 */
struct nvme_global_ctx *libnvme_host_get_global_ctx(libnvme_host_t h);
 ...
 */
struct nvme_transport_handle *libnvme_ctrl_get_transport_handle(libnvme_ctrl_t c);
 ...
 */
struct nvme_fabrics_config *libnvme_ctrl_get_config(libnvme_ctrl_t c);
 ...
 * Return: 0 on success or negative error code otherwise
 */
int libnvme_scan_ctrl(struct nvme_global_ctx *ctx, const char *name, libnvme_ctrl_t *c);
...
/**
 * libnvme_init_ctrl() - Initialize libnvme_ctrl_t object for an existing controller.
 * @h:		libnvme_host_t object
 ...
 * Return: 0 on success, or negative error code otherwise.
 */
int libnvme_scan_topology(struct nvme_global_ctx *ctx, libnvme_scan_filter_t f, void *f_args);
