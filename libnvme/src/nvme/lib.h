 ...
 */
const char *libnvme_transport_handle_get_name(struct libnvme_transport_handle *hdl);
 ...
 * Return: None.
 */
void libnvme_transport_handle_set_submit_entry(struct libnvme_transport_handle *hdl,
 ...
 * Return: None.
 */
void libnvme_transport_handle_set_submit_exit(struct libnvme_transport_handle *hdl,
 ...
 * Return: None.
 */
void libnvme_transport_handle_set_decide_retry(struct libnvme_transport_handle *hdl,
