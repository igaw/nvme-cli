 ...
 */
struct nvme_global_ctx *libnvme_create_global_ctx(FILE *fp, int log_level);
 ...
 */
void libnvme_free_global_ctx(struct nvme_global_ctx *ctx);
 ...
 */
void libnvme_set_logging_level(struct nvme_global_ctx *ctx, int log_level,
 ...
 */
int libnvme_get_logging_level(struct nvme_global_ctx *ctx, bool *log_pid,
		bool *log_tstamp);
 ...
 */
int libnvme_open(struct nvme_global_ctx *ctx, const char *name,
 ...
 */
void libnvme_close(struct nvme_transport_handle *hdl);

/**
 * libnvme_transport_handle_get_fd - Return file descriptor from transport handle
 * @hdl:	Transport handle
 *
 ...
 */
int libnvme_transport_handle_get_fd(struct nvme_transport_handle *hdl);

/**
 * libnvme_transport_handle_get_name - Return name of the device transport handle
 * @hdl:	Transport handle
 *
 * Return: Device file name, otherwise -1.
 */
const char *libnvme_transport_handle_get_name(struct nvme_transport_handle *hdl);
 ...
 */
bool libnvme_transport_handle_is_blkdev(struct nvme_transport_handle *hdl);
 ...
 */
bool libnvme_transport_handle_is_chardev(struct nvme_transport_handle *hdl);
 ...
 * otherwise false.
 */
bool libnvme_transport_handle_is_direct(struct nvme_transport_handle *hdl);
 ...
 * otherwise false.
 */
bool libnvme_transport_handle_is_mi(struct nvme_transport_handle *hdl);
 ...
 * Return: None.
 */
void libnvme_transport_handle_set_submit_entry(struct nvme_transport_handle *hdl,
 ...
 * Return: None.
 */
void libnvme_transport_handle_set_submit_exit(struct nvme_transport_handle *hdl,
 ...
 * Return: None.
 */
void libnvme_transport_handle_set_decide_retry(struct nvme_transport_handle *hdl,
 ...
 */
void libnvme_set_probe_enabled(struct nvme_global_ctx *ctx, bool enabled);
 ...
 */
void libnvme_set_dry_run(struct nvme_global_ctx *ctx, bool enable);
 ...
 */
void libnvme_set_ioctl_probing(struct nvme_global_ctx *ctx, bool enable);
