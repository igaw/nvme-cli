 ...
 *    value, represented by &enum libnvme_mi_resp_status. Note that the
...
/**
 * enum libnvme_mi_message_type - NVMe-MI message type field.
...
/**
 * enum libnvme_mi_ror: Request or response field.
...
/**
 * enum libnvme_mi_resp_status - values for the response status field
...
/**
 * struct libnvme_mi_msg_hdr - General MI message header.
...
/**
 * struct libnvme_mi_msg_resp - Generic response type.
 * @hdr: the general request/response message header
 * @status: response status value (see &enum libnvme_mi_resp_status)
 ...
 */
struct libnvme_mi_msg_resp {
	struct libnvme_mi_msg_hdr hdr;
	__u8	status;
	__u8	rsvd0[3];
};

/**
 * enum libnvme_mi_mi_opcode - Operation code for supported NVMe-MI commands.
 * @libnvme_mi_mi_opcode_mi_data_read: Read NVMe-MI Data Structure
 * @libnvme_mi_mi_opcode_subsys_health_status_poll: Subsystem Health Status Poll
 * @libnvme_mi_mi_opcode_configuration_set: MI Configuration Set
 * @libnvme_mi_mi_opcode_configuration_get: MI Configuration Get
 */
enum libnvme_mi_mi_opcode {
	libnvme_mi_mi_opcode_mi_data_read = 0x00,
	libnvme_mi_mi_opcode_subsys_health_status_poll = 0x01,
	libnvme_mi_mi_opcode_configuration_set = 0x03,
	libnvme_mi_mi_opcode_configuration_get = 0x04,
};

/**
 * struct libnvme_mi_mi_req_hdr - MI request message header.
...
/**
 * struct libnvme_mi_mi_resp_hdr - MI response message header.
 * @hdr: generic MI message header
...
/**
 * enum libnvme_mi_dtyp - Data Structure Type field.
 * @libnvme_mi_dtyp_subsys_info: NVM Subsystem Information
 * @libnvme_mi_dtyp_port_info: Port information
 * @libnvme_mi_dtyp_ctrl_list: Controller List
 * @libnvme_mi_dtyp_ctrl_info: Controller Information
 * @libnvme_mi_dtyp_opt_cmd_support: Optionally Supported Command List
 * @libnvme_mi_dtyp_meb_support: Management Endpoint Buffer Command Support List
 *
 ...
 */
enum libnvme_mi_dtyp {
	libnvme_mi_dtyp_subsys_info = 0x00,
	libnvme_mi_dtyp_port_info = 0x01,
	libnvme_mi_dtyp_ctrl_list = 0x02,
	libnvme_mi_dtyp_ctrl_info = 0x03,
	libnvme_mi_dtyp_opt_cmd_support = 0x04,
	libnvme_mi_dtyp_meb_support = 0x05,
};

/**
 * enum libnvme_mi_config_id - NVMe-MI Configuration identifier.
 ...
 *
 * See &libnvme_mi_mi_config_get() and &libnvme_mi_config_set().
 */
enum libnvme_mi_config_id {
...
/**
 * enum libnvme_mi_config_smbus_freq - SMBus/I2C frequency values
 ...
 * &libnvme_mi_mi_config_get_smbus_freq() and &libnvme_mi_mi_config_set_smbus_freq().
 */
enum libnvme_mi_config_smbus_freq {
...
/**
 * struct libnvme_mi_aem_supported_list_header - Asynchronous Event Supported List Header.
 ...
 */
struct libnvme_mi_aem_supported_list_header {
	__u8 numaes;
...
/**
 * struct libnvme_mi_aem_supported_item - AE Supported List Item
 * @aesl: AE supported list item length
 * @aesi: AE supported info
 *
 * Following this header should be hdr.numaes entries of
 * libnvme_mi_aem_supported_item structures
 */
struct libnvme_mi_aem_supported_item {
	__u8 aesl;//Length of this item.  Set to 3
	__le16 aesi;
} __attribute__((packed));

/**
 * libnvme_mi_aem_aesi_get_aese() - return aese from aesi field
 * @aesi: aesi field from @libnvme_mi_aem_supported_item
 *
 * Returns: A bool representing the aese value
 */
bool libnvme_mi_aem_aesi_get_aese(__le16 aesi);

/**
 * libnvme_mi_aem_aesi_get_aesid() - return aesid from aesi field
 * @aesi: aesi field from @libnvme_mi_aem_supported_item
 *
 * Returns: aesid value
 */
__u8 libnvme_mi_aem_aesi_get_aesid(__le16 aesi);

/**
 * libnvme_mi_aem_aesi_set_aesid() - set aesid in the aesi field
 * @item: Pointer to @libnvme_mi_aem_supported_item to update the aesi field
 * @aesid: aesid value to use
 */
void libnvme_mi_aem_aesi_set_aesid(struct libnvme_mi_aem_supported_item *item, __u8 aesid);

/**
 * libnvme_mi_aem_aesi_set_aee() - set aee in the aesi field
 * @item: Pointer to @libnvme_mi_aem_supported_item to update the aesi field
 * @enabled: aee value to use
 */
void libnvme_mi_aem_aesi_set_aee(struct libnvme_mi_aem_supported_item *item, bool enabled);

/**
 * struct libnvme_mi_aem_supported_list - AE Supported List received with GET CONFIG Asynchronous Event
 * @hdr: AE supported list header
 *
 * Following this header should be hdr.numaes entries of
 * libnvme_mi_aem_supported_item structures
 */
struct libnvme_mi_aem_supported_list {
	struct libnvme_mi_aem_supported_list_header hdr;
} __attribute__((packed));

/**
 * struct libnvme_mi_aem_enable_item - AE Enabled item entry
 * @aeel: AE Enable Length (length of this structure which is 3)
 * @aeei: AE Enable Info
 *
 */
struct libnvme_mi_aem_enable_item {
	__u8 aeel;
	__le16 aeei;
} __attribute__((packed));
 ...
 * @aeei: aeei field from @libnvme_mi_aem_enable_item
 *
 * Returns: aee value
 */
bool libnvme_mi_aem_aeei_get_aee(__le16 aeei);
 ...
 * Returns: aeeid value
 */
__u8 libnvme_mi_aem_aeei_get_aeeid(__le16 aeei);

/**
 * libnvme_mi_aem_aeei_set_aeeid() - set aeeid in the aeei field
 * @item: Pointer to @libnvme_mi_aem_enable_item to update the aeei field
 * @aeeid: aeeid value to use
 */
void libnvme_mi_aem_aeei_set_aeeid(struct libnvme_mi_aem_enable_item *item, __u8 aeeid);

/**
 * libnvme_mi_aem_aeei_set_aee() - set aee in the aeei field
 * @item: Pointer to @libnvme_mi_aem_enable_item to update the aee field
 * @enabled: aee value to use
 */
void libnvme_mi_aem_aeei_set_aee(struct libnvme_mi_aem_enable_item *item, bool enabled);

/**
 * struct libnvme_mi_aem_enable_list_header - AE Enable list header
 ...
 */
struct libnvme_mi_aem_enable_list_header {
	__u8 numaee;
	__u8 aeelver;
	__le16 aeetl;
	__u8 aeelhl;
...
/**
 * struct libnvme_mi_aem_enable_list - AE enable list sent with SET CONFIG Asyncronous Event
 * @hdr: AE enable list header
 *
 * Following this header should be hdr.numaee entries of libnvme_mi_aem_enable_item structures
 */
struct libnvme_mi_aem_enable_list {
	struct libnvme_mi_aem_enable_list_header hdr;
} __attribute__((packed));

/**
 * struct libnvme_mi_aem_occ_data - AEM Message definition.
 ...
 *
 * A single entry of ae occurrence data that comes with an libnvme_aem_msg.
 ...
 */
struct libnvme_mi_aem_occ_data {
	__u8 aelhlen;
	__u8 aeosil;
	__u8 aeovsil;
	struct {
...
/**
 * struct libnvme_mi_aem_occ_list_hdr - AE occurrence list header
 ...
 * libnvme_mi_aem_occ_data structures (including variable payaloads) are included.
 * Following this header is each of the numaeo occurrence data structures.
 */
struct libnvme_mi_aem_occ_list_hdr {
	__u8 numaeo;
	__u8 aelver;
...
/**
 * libnvme_mi_aem_aemti_get_aemgn() - return aemgn from aemti field
 * @aemti: aemti field from @libnvme_mi_aem_occ_list_hdr
 *
 * Returns: aemgn value
 */
__u8 libnvme_mi_aem_aemti_get_aemgn(__u8 aemti);

/**
 * libnvme_mi_aem_aeolli_get_aeoltl() - return aeoltl from aeolli field
 * @aeolli: Pointer to 3 byte aeolli field from @libnvme_mi_aem_occ_list_hdr
 *
 * Returns: aeoltl value
 */
__u32 libnvme_mi_aem_aeolli_get_aeoltl(__u8 *aeolli);

/**
 * libnvme_mi_aem_aeolli_set_aeoltl() - set aeoltl in the aeolli field
 * @hdr:Pointer to @libnvme_mi_aem_occ_list_hdr to set the aeolli field
 * @aeoltl: aeoltl value to use
 */
void libnvme_mi_aem_aeolli_set_aeoltl(struct libnvme_mi_aem_occ_list_hdr *hdr, __u32 aeoltl);

/**
 * struct libnvme_mi_aem_msg - AEM Message definition.
 ...
 * defined by the libnvme_mi_aem_occ_data structure which will follow the
 * occ_list_hdr.  Each libnvme_mi_aem_occ_data structure has a fixed length header
 * but a variable length payload ude to occurrence specific and vendor specific
 * info.  For this reason, do not index the libnvme_mi_ae_occ data structures by
 * array or fixed offset.
 */
struct libnvme_mi_aem_msg {
	struct libnvme_mi_msg_hdr hdr;
	struct libnvme_mi_aem_occ_list_hdr occ_list_hdr;
} __attribute__((packed));

/* Admin command definitions */

/**
 * struct libnvme_mi_admin_req_hdr - Admin command request header.
 * @hdr: Generic MI message header
 ...
 * NVMe-MI.
 */
struct libnvme_mi_admin_req_hdr {
	struct libnvme_mi_msg_hdr hdr;
	__u8	opcode;
	__u8	flags;
	__le16	ctrl_id;
...
/**
 * struct libnvme_mi_admin_resp_hdr - Admin command response header.
 * @hdr: Generic MI message header
 ...
 */
struct libnvme_mi_admin_resp_hdr {
	struct libnvme_mi_msg_hdr hdr;
	__u8	status;
	__u8	rsvd0[3];
...
/**
 * enum libnvme_mi_control_opcode - Operation code for Control Primitives.
 * @libnvme_mi_control_opcode_pause: Suspend response transmission/timeout
 * @libnvme_mi_control_opcode_resume: Resume from a paused condition
 * @libnvme_mi_control_opcode_abort: Re-initialize a Command Slot to the Idle state
 * @libnvme_mi_control_opcode_get_state: Get the state of a Command Slot
 * @libnvme_mi_control_opcode_replay: Retransmit the Response Message
 */
enum libnvme_mi_control_opcode {
	libnvme_mi_control_opcode_pause			= 0x00,
	libnvme_mi_control_opcode_resume			= 0x01,
	libnvme_mi_control_opcode_abort			= 0x02,
	libnvme_mi_control_opcode_get_state	= 0x03,
	libnvme_mi_control_opcode_replay			= 0x04,
};

/**
 * struct libnvme_mi_control_req - The Control Primitive request.
 * @hdr: Generic MI message header
 * @opcode: Control Primitive Opcodes (using &enum libnvme_mi_control_opcode)
 * @tag: flag - Opaque value passed from request to response
 * @cpsp: Control Primitive Specific Parameter
 *
 */
struct libnvme_mi_control_req {
	struct libnvme_mi_msg_hdr hdr;
	__u8	opcode;
	__u8	tag;
	__le16	cpsp;
...
/** struct libnvme_mi_control_resp - The Control Primitive response.
 * @hdr: Generic MI message header
 * @status: Generic response code, non-zero on failure
 * @tag: flag - Opaque value passed from request to response
...
struct libnvme_mi_control_resp {
	struct libnvme_mi_msg_hdr hdr;
	__u8	status;
	__u8	tag;
	__le16	cpsr;
 ...
 * @ep: &libnvme_mi_ep_t object
 * @hdl: &libnvme_transport_handle current position of iterator
 *
 ...
 * @hdl: &libnvme_trasnport_handle object, set on each iteration
 *
 ...
 * @hdl: &libnvme_transport_handle object, set on each iteration
 * @_hdl: &libnvme_transport_handle object used as temporary storage
 *
 ...
 *
 * See: &struct libnvme_mi_mi_req_hdr and &struct libnvme_mi_mi_resp_hdr.
 *
 * Return: The nvme command status if a response was received (see
 * &enum nvme_status_field) or -1 with errno set otherwise..
 */
int libnvme_mi_mi_xfer(libnvme_mi_ep_t ep,
		       struct libnvme_mi_mi_req_hdr *mi_req,
 ...
 *
 * See &enum libnvme_mi_config_id for identifiers.
 *
 * Return: The nvme command status if a response was received (see
 * &enum nvme_status_field) or -1 with errno set otherwise..
 */
						   ...
						   enum libnvme_mi_config_smbus_freq *freq)
{
	...
	if (!rc)
		*freq = (enum libnvme_mi_config_smbus_freq)(tmp & 0x3);
	return rc;
}
...
int libnvme_mi_mi_config_get_async_event(libnvme_mi_ep_t ep,
				__u8 *aeelver,
				struct libnvme_mi_aem_supported_list *list,
...
int libnvme_mi_mi_config_set_async_event(libnvme_mi_ep_t ep,
				...
				__u8 aemd,
				__u8 aerd,
				struct libnvme_mi_aem_enable_list *enable_list,
				size_t enable_list_size,
				struct libnvme_mi_aem_occ_list_hdr *occ_list,
				...
				size_t *occ_list_size)
{
	...
	struct libnvme_mi_aem_enable_list list = {0};

	list.hdr.aeelhl = sizeof(struct libnvme_mi_aem_enable_list_header);
	list.hdr.aeelver = 0;
	list.hdr.aeetl = sizeof(struct libnvme_mi_aem_enable_list_header);
	list.hdr.numaee = 0;
 ...
 *
 * See: &struct libnvme_mi_admin_req_hdr and &struct libnvme_mi_admin_resp_hdr.
 *
 * Return: The nvme command status if a response was received (see
 * &enum nvme_status_field) or -1 with errno set otherwise..
 */
int libnvme_mi_admin_xfer(struct libnvme_transport_handle *hdl,
		       ...
		       size_t req_data_size,
		       struct libnvme_mi_admin_resp_hdr *admin_resp,
 ...
 * @ep: endpoint for MI communication
 * @opcode: Control Primitive opcode (using &enum libnvme_mi_control_opcode)
 * @cpsp: Control Primitive Specific Parameter
 ...
 *
 * See: &enum libnvme_mi_control_opcode
 *
 */
