 ...
 */
void libnvme_mi_aem_aesi_set_aesid(struct nvme_mi_aem_supported_item *item, __u8 aesid);
 ...
 */
void libnvme_mi_aem_aesi_set_aee(struct nvme_mi_aem_supported_item *item, bool enabled);
 ...
 */
void libnvme_mi_aem_aeei_set_aeeid(struct nvme_mi_aem_enable_item *item, __u8 aeeid);
 ...
 * @enabled: aee value to use
 */
void libnvme_mi_aem_aeei_set_aee(struct nvme_mi_aem_enable_item *item, bool enabled);
 ...
 */
void libnvme_mi_aem_aeolli_set_aeoltl(struct nvme_mi_aem_occ_list_hdr *hdr, __u32 aeoltl);
 ...
 *
 */
int libnvme_mi_set_csi(nvme_mi_ep_t ep, uint8_t csi);
 ...
 */
nvme_mi_ep_t libnvme_mi_first_endpoint(struct nvme_global_ctx *ctx);
 ...
 */
nvme_mi_ep_t libnvme_mi_next_endpoint(struct nvme_global_ctx *ctx, nvme_mi_ep_t e);
 ...
 */
int libnvme_mi_ep_set_timeout(nvme_mi_ep_t ep, unsigned int timeout_ms);
 ...
 */
void libnvme_mi_ep_set_mprt_max(nvme_mi_ep_t ep, unsigned int mprt_max_ms);
 ...
 */
unsigned int libnvme_mi_ep_get_timeout(nvme_mi_ep_t ep);
 ...
 */
struct nvme_transport_handle *libnvme_mi_first_transport_handle(nvme_mi_ep_t ep);
 ...
 */
struct nvme_transport_handle *libnvme_mi_next_transport_handle(nvme_mi_ep_t ep,
 ...
 */
nvme_mi_ep_t libnvme_mi_open_mctp(struct nvme_global_ctx *ctx,
 ...
 */
void libnvme_mi_close(nvme_mi_ep_t ep);
 ...
 */
struct nvme_global_ctx *libnvme_mi_scan_mctp(void);
 ...
 */
int libnvme_mi_scan_ep(nvme_mi_ep_t ep, bool force_rescan);
 ...
 */
struct nvme_transport_handle *libnvme_mi_init_transport_handle(nvme_mi_ep_t ep, __u16 ctrl_id);
 ...
 */
__u16 libnvme_mi_ctrl_id(struct nvme_transport_handle *hdl);
 ...
 *         NULL on failure.
 */
char *libnvme_mi_endpoint_desc(nvme_mi_ep_t ep);
 ...
 * &enum nvme_status_field) or -1 with errno set otherwise..
 */
int libnvme_mi_mi_xfer(nvme_mi_ep_t ep,
 ...
 * &enum nvme_status_field) or -1 with errno set otherwise..
 */
int libnvme_mi_mi_read_mi_data_subsys(nvme_mi_ep_t ep,
 ...
 * &enum nvme_status_field) or -1 with errno set otherwise..
 */
int libnvme_mi_mi_read_mi_data_port(nvme_mi_ep_t ep, __u8 portid,
 ...
 * &enum nvme_status_field) or -1 with errno set otherwise..
 */
int libnvme_mi_mi_read_mi_data_ctrl_list(nvme_mi_ep_t ep, __u8 start_ctrlid,
 ...
 * &enum nvme_status_field) or -1 with errno set otherwise..
 */
int libnvme_mi_mi_read_mi_data_ctrl(nvme_mi_ep_t ep, __u16 ctrl_id,
 ...
 * &enum nvme_status_field) or -1 with errno set otherwise..
 */
int libnvme_mi_mi_subsystem_health_status_poll(nvme_mi_ep_t ep, bool clear,
 ...
 * &enum nvme_status_field) or -1 with errno set otherwise..
 */
int libnvme_mi_mi_config_get(nvme_mi_ep_t ep, __u32 dw0, __u32 dw1,
			  __u32 *nmresp);
 ...
 * &enum nvme_status_field) or -1 with errno set otherwise..
 */
int libnvme_mi_mi_config_set(nvme_mi_ep_t ep, __u32 dw0, __u32 dw1);
 ...
 * &enum nvme_status_field) or -1 with errno set otherwise..
 */
static inline int libnvme_mi_mi_config_get_smbus_freq(nvme_mi_ep_t ep, __u8 port,
 ...
 * &enum nvme_status_field) or -1 with errno set otherwise..
 */
static inline int libnvme_mi_mi_config_set_smbus_freq(nvme_mi_ep_t ep, __u8 port,
						   enum nvme_mi_config_smbus_freq freq)
{
	__u32 dw0 = port << 24 |
		(freq & 0x3) << 8 |
 ...
 * &enum nvme_status_field) or -1 with errno set otherwise..
 */
static inline int libnvme_mi_mi_config_set_health_status_change(nvme_mi_ep_t ep,
							     __u32 mask)
{
 ...
 * &enum nvme_status_field) or -1 with errno set otherwise..
 */
static inline int libnvme_mi_mi_config_get_mctp_mtu(nvme_mi_ep_t ep, __u8 port,
						 __u16 *mtu)
{
	__u32 tmp, dw0;
	int rc;
 ...
 * &enum nvme_status_field) or -1 with errno set otherwise..
 */
static inline int libnvme_mi_mi_config_set_mctp_mtu(nvme_mi_ep_t ep, __u8 port,
						 __u16 mtu)
{
 ...
 * &enum nvme_status_field) or -1 with errno set otherwise..
 */
int libnvme_mi_mi_config_get_async_event(nvme_mi_ep_t ep,
				__u8 *aeelver,
 ...
 * &enum nvme_status_field) or -1 with errno set otherwise..
 */
int libnvme_mi_mi_config_set_async_event(nvme_mi_ep_t ep,
				bool envfa,
				bool empfa,
				bool encfa,
				__u8 aemd,
...
static inline int libnvme_mi_aem_ack(nvme_mi_ep_t ep,
				struct nvme_mi_aem_occ_list_hdr *occ_list,
				size_t *occ_list_size)
{
 ...
 * &enum nvme_status_field) or -1 with errno set otherwise..
 */
int libnvme_mi_admin_xfer(struct nvme_transport_handle *hdl,
 ...
 *
 */
int libnvme_mi_control(nvme_mi_ep_t ep, __u8 opcode,
 ...
 */
struct nvme_mi_event *libnvme_mi_aem_get_next_event(nvme_mi_ep_t ep);
...
/**
 * struct nvme_mi_aem_config - Provided for libnvme_mi_aem_enable
 ...
 */
int libnvme_mi_aem_get_fd(nvme_mi_ep_t ep);
 ...
 */
int libnvme_mi_aem_enable(nvme_mi_ep_t ep,
 ...
 * Return: 0 is a success, nonzero is an error and errno may be read for further details
 */
int libnvme_mi_aem_get_enabled(nvme_mi_ep_t ep,
 ...
 * Return: 0 is a success, nonzero is an error and errno may be read for further details
 */
int libnvme_mi_aem_disable(nvme_mi_ep_t ep);
 ...
 * Return: 0 is a success, nonzero is an error and errno may be read for further details
 */
int libnvme_mi_aem_process(nvme_mi_ep_t ep, void *userdata);
