 ...
 */
int libnvme_submit_admin_passthru(struct nvme_transport_handle *hdl,
 ...
 * received (see &enum nvme_status_field) or a negative error otherwise.
 */
int libnvme_submit_io_passthru(struct nvme_transport_handle *hdl,
		struct nvme_passthru_cmd *cmd);
 ...
 * otherwise.
 */
int libnvme_reset_subsystem(struct nvme_transport_handle *hdl);
 ...
 */
int libnvme_reset_ctrl(struct nvme_transport_handle *hdl);
 ...
 */
int libnvme_rescan_ns(struct nvme_transport_handle *hdl);
 ...
 */
int libnvme_get_nsid(struct nvme_transport_handle *hdl, __u32 *nsid);
